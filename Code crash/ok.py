...
while True:
    ...
    if ball_1_x - ball_1_radius < 0 or ball_1_x + ball_1_radius > width - offset1:
        ball_1_speed_x = -ball_1_speed_x
    if ball_1_y - ball_1_radius < 0 or ball_1_y + ball_1_radius > height:
        ball_1_speed_y = -ball_1_speed_y

    if ball_2_x - ball_2_radius < 0 or ball_2_x + ball_2_radius > width - offset2:
